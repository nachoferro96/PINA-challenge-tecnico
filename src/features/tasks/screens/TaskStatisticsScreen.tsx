...
function StatisticsLoadingState() {
  ...
  return (
    <View accessibilityLabel="Cargando estadísticas" style={styles.loading}>
      <View
        style={[styles.loadingTotal, { backgroundColor: colors.surfaceStrong }]}
      />
      <View
        style={[styles.loadingLabel, { backgroundColor: colors.surface }]}
      />
      {[0, 1].map(section => (
    ...
    content = (
      <>
        ...
        <Text style={[styles.note, { color: colors.textSecondary }]}>
          Las estadísticas se calculan desde las tareas cargadas y no se
